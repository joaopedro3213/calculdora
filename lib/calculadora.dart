...
class Calculadora extends StatefulWidget {
    ...
    @override
    State Calculadora> createState() => _ CalculadoraState();
}
...
_expressao += valor;
    ...
    void _calcularResultado(){ 
        try {
         ...
         debugPrint('Erro: não foi possivel calcular: $e');
        }
    }

  double_calcularExpressao (String expressao) {
